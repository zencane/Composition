        ...
        {activeMaps.map(map => {
          ...
          return (
            <div key={map.uuid} className="bg-[#16202a] border border-gray-800 rounded-lg overflow-hidden flex flex-col transition-all hover:border-gray-600 hover:shadow-2xl">
              {/* Card Header with fixed height and background color to prevent jump */}
              <div className="h-24 relative flex items-center px-4 overflow-hidden group bg-[#0f1923]">
                <img 
                   src={map.splash} 
                   alt="" 
                    ...
                    <div key={i} className="flex items-center justify-between gap-2 p-2 bg-[#0f1923]/70 backdrop-blur-sm rounded-md border border-gray-800/80 hover:bg-[#1a252e] transition-colors">
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0">
                          <span className="text-[10px] font-black uppercase text-gray-400 leading-none truncate mb-1 text-xs">
                            {player ? player.name : 'VACANT'}
                          </span>
                          <span className="text-xl font-black uppercase text-white tracking-wide truncate leading-tight">
