...
const App: React.FC = () => {
  ...
  return (
    <>
      {/* Team Data Modal - Rendered at the absolute root of the tree to avoid containing block issues */}
      {isDataModalOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-[#0f1923]/95 backdrop-blur-md" onClick={() => setIsDataModalOpen(false)}></div>
      ...
      <div className="min-h-screen bg-[#0f1923]">
        ...
        <div className="p-4 md:p-8 max-w-[1800px] mx-auto space-y-12 pb-24 animate-fade-in relative">
          {/* Header */}
